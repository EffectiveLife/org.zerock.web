			...
			<div class="box">
                ...
                <div class="box-body">
                    ...
                    <select name="searchType">
                        ...
                        <option value="c" <c:out value="${cri.searchType eq 'c'? 'selected' :''}"/>>Contents</option>
                        <option value="w" <c:out value="${cri.searchType eq 'w'? 'selected' :''}"/>>Writer</option>
                        <option value="tc" <c:out value="${cri.searchType eq 'tc'? 'selected' :''}"/>>Title OR Contents</option>
                        <option value="cw" <c:out value="${cri.searchType eq 'cw'? 'selected' :''}"/>>Contents OR Writer</option>
                        <option value="tcw" <c:out value="${cri.searchType eq 'tcw'? 'selected' :''}"/>>Title OR Contents OR Writer</option>
