        ...
        <div class="col-md-12">
            <div class="box box-success">
                ...
                <c:if test="${not empty login}">
                    <div class="box-body">
                        <label for="exampleInputEmail1">Writer</label><input class="form-control" type="text"
                                                                             value="${login.uid}" placeholder="USER ID" id="newReplyWriter" readonly="readonly" />
                        <label for="exampleInputEmail1">Reply Text</label><input class="form-control" type="text"
                                                                                 placeholder="USER TEXT" id="newReplyText"/>
                    </div>
